...
public class Reactant {
	...
	public double getInitial_number() {
		return initial_number;
	}

	public void setInitial_number(double initialNumber) {
...
//		System.out.println(my_chemical_name+" number is "+number);
	...
	public void setInitialNumberByConcentration() {
		int int_number = (int) (my_concentration * volume * NA);
		initial_number = (double) int_number;
	}
